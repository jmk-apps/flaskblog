...
from flaskblog.forms import (LoginForm, RegistrationForm, UpdateAccountForm, PostForm, RequestResetForm,
                             ResetPasswordForm)
from flaskblog.models import User, Post
from werkzeug.security import generate_password_hash, check_password_hash
from flask_login import login_user, logout_user, current_user, login_required

db_posts = [{"title": "My Updated Post", "content": "My first updated post!\r\n\r\nThis is exciting!", "user_id": 1},
...
def user_posts(username):
    ...
    posts = db.paginate(db.select(Post).filter_by(author=user).order_by(Post.date_posted.desc()), page=page, per_page=5)
